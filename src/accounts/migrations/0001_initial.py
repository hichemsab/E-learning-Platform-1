...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Year', models.CharField(choices=[('L1', 'L1'), ('L2', 'L2'), ('L3', 'L3'), ('M1', 'M1'), ('M2', 'M2')], default='L1', max_length=2, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Professor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('speciality', models.CharField(choices=[('MI', 'MI'), ('INFO', 'INFO'), ('MATH', 'MATH'), ('SI', 'SI'), ('ISIL', 'ISIL'), ('MATH', 'MATH'), ('STW', 'STW'), ('GLSD', 'GLSD'), ('MATHAPPLQ', 'MATHAPPLQ'), ('STW', 'STW'), ('GLSD', 'GLSD'), ('MATHAPPLQ', 'MATHAPPLQ')], default='MI', max_length=10, unique=True)),
                ('year', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.years')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
